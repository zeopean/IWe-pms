...
CREATE TABLE iwe_group(
  ...
  `name` varchar(50) NOT NULL COMMENT '群组名字',
...
CREATE TABLE iwe_project_option(
  ...
  `name` varchar(50) NOT NULL COMMENT '项目完成项名字',
  `status` TINYINT NOT NULL DEFAULT 0 COMMENT '状态',
...
CREATE TABLE iwe_task_issue(
  ...
  `name` varchar(50) NOT NULL COMMENT '任务分发名字',
...
CREATE TABLE iwe_bug(
  ...
  `name` varchar(50) NOT NULL COMMENT 'bug 名字',
  `description` varchar(500) NOT NULL COMMENT 'bug 描述',
...
CREATE TABLE iwe_document(
  ...
  `description` varchar(500) NOT NULL COMMENT '文档 描述',
...
CREATE TABLE iwe_notice(
  ...
  `name` varchar(50) NOT NULL COMMENT '消息 名字',
